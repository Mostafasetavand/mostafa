...
RoomR room[10];  // آرایه‌ای برای ذخیره اتاق‌ها
int teadad_rooms = 0;  // تعداد اتاق‌ها

// تابع برای ایجاد اتاق‌ها


// تابع برای نمایش اتاق‌ها
 extern void display_room(RoomR room) {
